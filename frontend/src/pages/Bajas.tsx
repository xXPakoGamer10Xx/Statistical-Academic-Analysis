      ...
      {isLoading ? (
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <KpiCard label="Total bajas por reprobación" value={data?.totales.bajas_reprobacion ?? 0} variant="amber" />
            <KpiCard label="Total bajas por deserción" value={data?.totales.bajas_desercion ?? 0} variant="red" />
          </div>
