...
import { Download, Image as ImageIcon, ChevronDown, FileText, History } from "lucide-react";
...
interface Props {
  ...
  /** Deshabilita la exportación (ej. sin filtros aplicados). */
  disabled?: boolean;
  /** Texto opcional al pasar el cursor cuando está deshabilitado. */
  disabledHint?: string;
}

export function ExportMenu({ onExportPdf, onExportImage, onExportHistorical, disabled, disabledHint }: Props) {
