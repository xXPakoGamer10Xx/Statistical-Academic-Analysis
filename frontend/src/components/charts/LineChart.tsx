...
export function LineChart({ title, categories, series, height = 320, formatter }: Props) {
  ...
  const option: EChartsOption = {
    ...
    xAxis: { type: "category", boundaryGap: false, data: categories, axisLabel: { color: textColor, rotate: categories.length > 6 ? 45 : 0, width: 90, overflow: "truncate" }, axisLine: { lineStyle: { color: isDark ? "#334155" : "#cbd5e1" } } },
